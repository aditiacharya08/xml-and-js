...
function getTotalTrips(data) {
  const passengers = data.passengers.data.passenger;
  let totalTrips = 0;
  
  for (let i = 0; i < passengers.length; i++) {
    totalTrips += Number(passengers[i].trips);
  }
  
  return totalTrips;
}

console.log("The total number of trips by all passengers is: " + getTotalTrips(data));
